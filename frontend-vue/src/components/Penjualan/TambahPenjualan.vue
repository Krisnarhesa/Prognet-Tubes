        ...
        tambahPenjualan() {
            axios
                ...
                .then((response) => {
                    ...
                    this.$router.push({
                        path: `/penjualan/detail/${newPenjualanId}`,
                    });
                });
        },
    },
...
<template>
    <div class="relative pt-12">
        ...
        <div
            class="max-w-lg mx-auto py-2 px-8 border border-gray-200 rounded-xl"
        >
            <div class="py-4 mb-5">
            ...
            <form @submit.prevent="tambahPenjualan">
                <div class="relative z-0 w-full mb-5 group">
                    <input
                        type="text"
                        v-model="dataPenjualan.nomortransaksi"
                        id="nomor_transaksi"
