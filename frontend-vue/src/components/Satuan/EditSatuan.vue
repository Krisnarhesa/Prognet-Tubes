...
<template>
    ...
    <div class="relative pt-12">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Tambah Satuan</span>
                    </div>
                </li>
            </ol>
            </nav>
        ...
        <div class="max-w-lg mx-auto py-2 px-8 border border-gray-200 rounded-xl">
            <div class="py-4 mb-5">
                <h3 class="text-2xl font-semibold text-blue-500">Edit Satuan</h3>
            </div>

            <form @submit.prevent="editSatuan(this.idUrl)" >
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" v-model="dataSatuan.satuan" id="satuan" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    <label for="satuan" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nama Satuan</label>
                </div>
